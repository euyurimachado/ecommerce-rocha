...
class CommerceSeeder extends Seeder
{
    ...
    {
        $categories = collect([
            ['name' => 'Whey Protein', 'icon' => 'WP', 'short_description' => 'Proteínas para ganho de massa e recuperação.', 'sort_order' => 10],
            ['name' => 'Creatina', 'icon' => 'CR', 'short_description' => 'Força, potência e performance diária.', 'sort_order' => 20],
            ['name' => 'Pré-treino', 'icon' => 'PT', 'short_description' => 'Energia e foco para treinos intensos.', 'sort_order' => 30],
            ['name' => 'Vitaminas', 'icon' => 'VT', 'short_description' => 'Saúde, imunidade e rotina equilibrada.', 'sort_order' => 40],
            ['name' => 'Snacks', 'icon' => 'SN', 'short_description' => 'Lanches práticos para qualquer hora.', 'sort_order' => 50],
            ['name' => 'Acessórios', 'icon' => 'AC', 'short_description' => 'Shakers, coqueteleiras e acessórios.', 'sort_order' => 60],
            ['name' => 'Combos e Kits', 'icon' => 'CK', 'short_description' => 'Seleções prontas para objetivos específicos.', 'sort_order' => 70],
        ])->mapWithKeys(function (array $data) {
            $category = Category::updateOrCreate(
                ['slug' => Str::slug($data['name'])],
                [
                    ...$data,
                    'seo_description' => $data['name'].' com entrega rápida em Campos dos Goytacazes, RJ. Produtos originais e atendimento especializado da Rocha Sports.',
                    'meta_title' => $data['name'].' em Campos dos Goytacazes | Rocha Sports',
                    'meta_description' => 'Compre '.$data['name'].' original com entrega rápida ou retirada na Rocha Sports em Campos dos Goytacazes.',
                    'is_active' => true,
                    'is_featured' => true,
                ],
            );
        ...
        foreach ($products as $index => $data) {
            Product::updateOrCreate(
                ...
                [
                    ...
                    'meta_description' => 'Compre '.$data['name'].' com entrega rápida em Campos dos Goytacazes ou retirada na Rocha Sports.',
                ],
            );
        }
        ...
        Banner::updateOrCreate(
            ...
            [
                ...
                'subtitle' => 'Whey, creatina, pré-treino e combos selecionados por especialistas Rocha Sports.',
