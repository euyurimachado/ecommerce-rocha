...
@section('content')
    <article class="mx-auto max-w-4xl px-4 py-10 lg:px-6">
        ...
        <div class="mt-8 space-y-6 text-slate-600">
            <section>
                <h2 class="text-lg font-bold text-slate-950 md:text-xl">Dados coletados</h2>
            ...
            <section>
                <h2 class="text-lg font-bold text-slate-950 md:text-xl">Finalidades</h2>
            ...
            <section>
                <h2 class="text-lg font-bold text-slate-950 md:text-xl">Compartilhamento</h2>
            ...
            <section>
                <h2 class="text-lg font-bold text-slate-950 md:text-xl">Segurança</h2>
