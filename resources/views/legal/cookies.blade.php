    ...
    <article class="mx-auto max-w-4xl px-4 py-10 lg:px-6">
        ...
        <div class="mt-8 grid gap-4 md:grid-cols-3">
            <section class="rounded-lg border border-slate-200 bg-white p-5">
                <h2 class="font-black text-slate-950">Essenciais</h2>
            ...
            <section class="rounded-lg border border-slate-200 bg-white p-5">
                <h2 class="font-black text-slate-950">Analíticos</h2>
            ...
            <section class="rounded-lg border border-slate-200 bg-white p-5">
                <h2 class="font-black text-slate-950">Marketing</h2>
        ...
        <section class="mt-8 rounded-lg border border-slate-200 bg-white p-5 text-slate-600">
            <h2 class="text-xl font-black text-slate-950">Registro de consentimento</h2>
